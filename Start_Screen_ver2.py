...
#____________________________________________________________#.dbをダウンロードさせる#______________________________________________________________________________
# ダウンロード用の関数
def download_db():
...
def save_db():
    ...
    if os.path.exists(new_db_path):
        # # 既存のデータベースファイルがあれば、バックアップを作成（オプション）
        # if os.path.exists(existing_db_path):
        #     shutil.copyfile(existing_db_path, 'my_database_backup.db')
...
#_____________________________________________________________スタート画面_________________________________________________________________________________________________________________________________
    ...
    def page2_1():
        ...
        if not st.session_state.personal_df.empty:
            if st.session_state.acount_name == "test":
